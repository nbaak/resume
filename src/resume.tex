...
\newcommand{\cvblock}[2]{
    \section*{#1}
    \begin{tabular}{>{\raggedleft}p{\leftcolsize}|l}
    		#2
    \end{tabular}    
}
...
\newcommand{\careeritem}[4]{
    \subsection*{}
    \begin{tabularx}{\textwidth}[ht]{>{\raggedleft}p{\leftcolsize}|l}
    #1 & \textbf{#2}\\
       & \textit{#3}\\
    #4
    \end{tabularx}
...
\cvblock{Skills}{
    \cvblockitem{Programming Languages}{Python, Php, Bash}
}
